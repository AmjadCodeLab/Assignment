...
var strDest = 'Amazon - Test Execution Result ' + totalDateString;

var reporter = new HtmlScreenshotReporter({
	dest: strDest,
	filename: 'Amazon - Test Execution Result.html',
	reportTitle: 'Amazon - Test Execution Result',
...
var reporterJUnit = new jasmineReporters.JUnitXmlReporter({
	...
	modifyReportFileName: function(generatedFileName, suite) {
		return 'Amazon - Test Execution Result.xml';
	},
	consolidateAll: true
});
